      ...
      >
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Paper sx={timeCard}>
            ...
            <Typography variant="h5" fontWeight="500" fontSize={18} color="#white">08:00</Typography>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Paper sx={timeCard}>
            ...
            <Typography variant="h5" fontWeight="500" fontSize={18} color="#white">09:00AM</Typography>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Paper sx={timeCard}>
            ...
            <Typography variant="h5" fontWeight="500" fontSize={18} color="#white">06:00PM</Typography>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Paper sx={timeCard}>
            ...
            <Typography variant="h5" fontWeight="500" fontSize={18} color="#white">{countleave || '00'}</Typography>
...
const timeCard = { backgroundColor: "#437986 !important", color: "white", p: 2, textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: 100, width: 200, borderRadius: 2, transition: "transform 0.2s, box-shadow 0.2s", "&:hover": { transform: "translateY(-4px)", boxShadow: 3 } };