    ...
    >
      ...
      >
        ...
        <Box
          ...
          sx={{
            borderRight: { xs: "none", md: `5px solid ${COLORS.primary}` },
            borderBottom: { xs: `5px solid ${COLORS.primary}`, md: "none" },
          }}
        >
          <Box
            sx={{
              ...
              MenuProps={{
                PaperProps: {
                  sx: {
                    ...
                    maxWidth: 250, // ✅ CRITICAL: limit width
                    overflowY: "auto",
                    whiteSpace: "normal", // ✅ allow wrap at paper level
                  },
                },
              }}
            >
                  ...
                  >
                    <Box
                      sx={{
                        ...
                        width: "100%", // ✅ REQUIRED for wrapping
                      }}
                    >
                      {/* PURPOSE (WRAPS DOWN) */}
                      <Typography
