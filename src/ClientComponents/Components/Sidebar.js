  ...
  return (
    ...
    >
      ...
      <Box
        sx={{
          flex: 1,
          background: `linear-gradient(180deg, ${COLORS.primary} 0%,${COLORS.softBg} 100%)`,
        ...
        >
          ...
          <Avatar
            ...
            sx={{
              ...
              border: `3px solid ${COLORS.texWhite}`,
              "&:hover": {
                opacity: 0.9,
          ...
          >
            <Box sx={{ fontSize: { xs: "10px", md: "16px" } }}>
              {formattedDate}
            </Box>
            ...
            <Box sx={{ fontSize: { xs: "10px", md: "18px" } }}>
              {formattedTime}
            </Box>
          </Typography>
